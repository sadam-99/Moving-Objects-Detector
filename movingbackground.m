hVidReader = vision.VideoFileReader('anshu.mp4','ImageColorSpace', 'RGB','VideoOutputDataType', 'single');
...
herode = vision.MorphologicalErode('Neighborhood', strel('rectangle',[20 4]));
